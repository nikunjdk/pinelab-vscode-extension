...
slug: "debit-emi-integration-steps-copy"
...
hidden: true
createdAt: "Wed Feb 12 2025 06:15:25 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Mon May 12 2025 13:26:11 GMT+0000 (Coordinated Universal Time)"
---
...
Below is a sample requests and response for the Generate Token API.
...
Below are the sample requests and responses for the Offer Discovery API.
  ...
  "product_details": [
    {
      ...
      "product_coupon_discount_amount": "1000"
    }
  ],
  "cart_coupon_discount_amount": "1000"
}
'
```
```curl cURL - PROD
...
'
```
```json Brand EMI Sample Response
{
  "issuers": [
    {
      "id": "25",
...
Below are the sample requests and sample responses for distinct Acquirers for Create Payment API.
     ...
     --data '
{
  "payments": [
    {
      "merchant_payment_reference": "12334567$guid",
      "payment_method": "DEBIT_EMI",
      "payment_amount": {
        "value": 1200000,
        "currency": "INR"
