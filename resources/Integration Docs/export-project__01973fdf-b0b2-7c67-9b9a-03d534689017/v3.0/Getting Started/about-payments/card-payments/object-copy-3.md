---
title: "Object includes OTP"
slug: "object-copy-3"
excerpt: "An overview of the response objects in the card payment APIs."
hidden: true
createdAt: "Fri Feb 21 2025 06:57:32 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Wed Mar 05 2025 04:32:28 GMT+0000 (Coordinated Universal Time)"
---
...
[block:parameters]
{
  "data": {
    ...
    "0-1": "<a href=\"https://developer.pluralonline.com/reference/object-copy-3#card-payment-response-object\" >Card Payment Response Object</a>",
    "1-0": "Send OTP",
    "1-1": "<a href=\"https://developer.pluralonline.com/reference/object-copy-3#otp-response-objects\" >OTP Response Objects</a>",
    "2-0": "Resend OTP",
    "2-1": "<a href=\"https://developer.pluralonline.com/reference/object-copy-3#otp-response-objects\" >OTP Response Objects</a>",
    "3-0": "Submit OTP",
    "3-1": "<a href=\"https://developer.pluralonline.com/reference/object-copy-3#otp-response-objects\" >OTP Response Objects</a>",
    "4-0": "Get Card Details",
    "4-1": "<a href=\"https://developer.pluralonline.com/reference/object-copy-3#get-card-details-response-object\" >Get Card Details Response Object</a>"
  },
  "cols": 2,
  "rows": 5,
  "align": [
...
```
```json Verify OTP Response Object
{
  "status": "SUCCESS"
}
```
...
[block:parameters]
{
  "data": {
    ...
    "0-2": "An array of strings that contains the details of the next steps.  \n  \nPossible values:<ul><li>`SUBMIT_OTP`: Use our Verify OTP API to submit the OTP.</li><li>`RESEND_OTP`: Use our resend OTP API to resend OTP to the registered mobile number of your customer.</li><li>`NONE`: When OTP verification fails for reasons such as exceeding the maximum retry attempts or entering an invalid OTP.</ul></li>",
    "1-0": "meta_data",
    "1-1": "`object`",
    "1-2": "An object that contains the metadata information.  \n  \nLearn more about the `meta_data` child object.",
    "2-0": "status",
    "2-1": "`string`",
    "2-2": "OTP Verification status.  \n  \nPossible values:<ul><li>`success`: When the OTP is successfully verified and the payment is initiated.</ul></li>"
  },
  "cols": 3,
  "rows": 3,
  "align": [
