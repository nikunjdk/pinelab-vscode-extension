---
title: "Object (COPY_test)"
slug: "object-copy"
excerpt: "Overview of the UPI payment response object."
hidden: true
createdAt: "Thu Dec 12 2024 12:41:48 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Fri Mar 28 2025 07:12:25 GMT+0000 (Coordinated Universal Time)"
---
...
```
```json Intent Payment Response Object
{
...
```
```json Intent Payment with QR Image Response Object
{
  "payment_id": "payment-id-1",
  "status": "INITIATED",
  "challenge_url": "https://acs.domain/authenticate",
...
```
```json Cancel Payment Response Object
{
  "payment_id": "payment-id-1",
  "status": "CANCELLED"
}
...
[block:parameters]
{
  "data": {
    ...
    "6-0": "error_detail",
    "6-1": "`object`",
    "6-2": "An object that contains the error details.<br><br><a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/upi-payments-object#error-detail-child-object\" >Learn more about our `error_detail` child object</a>.<br><br>**Note**: This object is returned only for the failed payment.",
    "7-0": "capture_data",
    "7-1": "`object`",
    ...
    "8-0": "created_at",
    "8-1": "`string`",
    "8-2": "The ISO 8601 UTC Timestamp, when the create order request was received by Plural.  \n  \nExample: `2024-08-20T09:02:51.265Z`",
    "9-0": "updated_at",
    "9-1": "`string`",
    "9-2": "The ISO 8601 UTC Timestamp, when the order response object is updated.  \n  \nExample: `2024-08-20T09:03:01.208Z`"
  },
  "cols": 3,
  "rows": 10,
  "align": [
