...
title: "Object"
slug: "object-2"
excerpt: "Overview of the Net banking payment response object."
hidden: false
createdAt: "Wed Nov 13 2024 09:17:57 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Mon Mar 24 2025 11:48:43 GMT+0000 (Coordinated Universal Time)"
---
Shown below is a sample response for a Create Payment API via the `NETBANKING` method.

```json Netbanking Payment Object
{
  "data": {
    ...
    "payments": [
      {
        ...
        "merchant_order_reference": "d99a376f-2b41-440d-841d-aa75e8abce13",
        "status": "PENDING",
        "payment_amount": {
          "value": 100,
          "currency": "INR"
...
[block:parameters]
{
  "data": {
    ...
    "4-0": "payment_method",
    "4-1": "`string`",
    "4-2": "Type of payment method.<br><br>Accepted values:<ul><li>`CARD`</li><li>`UPI`</li><li>`POINTS`</li><li>`NETBANKING`</ul></li>Example: `NETBANKING`",
    "5-0": "payment_option",
    "5-1": "`object`",
    "5-2": "An object that contains the details of the payment options.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/reference/object-2#payment-option-child-object\" >Learn more about our `payment_option` child object</a>.",
    "6-0": "acquirer_data",
    "6-1": "`object`",
    ...
    "7-0": "error_detail",
    "7-1": "`object`",
    "7-2": "An object that contains the error details.<br><br><a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/reference/object-2#error-detail-child-object\" >Learn more about our `error_detail` child object</a>.<br><br>**Note**: This object is returned only for the failed payment.",
    "8-0": "created_at",
    "8-1": "`string`",
    "8-2": "The ISO 8601 UTC Timestamp, when the create payment request was received by Plural.  \n  \nExample: `2024-07-11T06:52:12.484Z`",
    "9-0": "updated_at",
    "9-1": "`string`",
    "9-2": "The ISO 8601 UTC Timestamp, when the payment response object is updated.  \n  \nExample: `2024-07-11T06:59:38.260Z`"
  },
  "cols": 3,
  "rows": 10,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "netbanking_data",
    "0-1": "`object`",
    "0-2": "An object that contains the netbanking details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/reference/object-2#netbanking-data-child-object\" >Learn more about our `netbanking_data` child object</a>."
  },
  "cols": 3,
  "rows": 1,
  "align": [
...
The table below lists the various parameters in the `netbanking_data` child object. This object is part of the `payment_option` object.
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "pay_code",
    "0-1": "`string`",
    "0-2": "Bank code in the Plural database.<br><br>Accepted values:<ul><li>`NB1531`</ul></li>Example: `NB1531`  \n  \nRefer to our <a href=\"https://developer.pluralonline.com/docs/supported-bank\" target=\"_blank\">Supported Banks</a> to know more.",
    "1-0": "txn_mode",
    "1-1": "`string`",
