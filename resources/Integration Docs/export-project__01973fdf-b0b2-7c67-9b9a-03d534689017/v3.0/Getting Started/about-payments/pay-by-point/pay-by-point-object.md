---
title: "Object"
slug: "pay-by-point-object"
excerpt: "Overview of the pay by points APIs response objects."
hidden: false
createdAt: "Thu Sep 12 2024 09:11:13 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Thu Mar 27 2025 07:24:53 GMT+0000 (Coordinated Universal Time)"
---
## Check Point Balance

Shown below is a sample response for a Check Point Balance API.

```json Check Point Balance Response Object
{
  "balance": {
    "value": 23718050,
    "currency": "INR"
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "balance",
    "0-1": "`object`",
    "0-2": "An object that contains the card balance details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/reference/pay-by-point-object#balance-child-object\" >Learn more about our `balance` child object</a>.",
    "1-0": "redeemable_amount",
    "1-1": "`object`",
    "1-2": "An object that contains the redeemable amount details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/reference/pay-by-point-object#redeemable-amount-child-object\" >Learn more about our `redeemable_amount` child object</a>.",
    "2-0": "redeemable_points",
    "2-1": "`integer`",
    "2-2": "Total redeemable points available in the card.  \n  \nExample: `140`",
    "3-0": "is_eligible",
    "3-1": "`boolean`",
    "3-2": "Card eligibility status.  \n  \nExample: `true`"
  },
  "cols": 3,
  "rows": 4,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "value",
    "0-1": "`integer`",
    "0-2": "Balance available on the card.  \n  \nExample: `23718050`",
    "1-0": "currency",
    "1-1": "`string`",
...
```json Pay by Points Response Object
{
  "data": {
...
[block:parameters]
{
  "data": {
    ...
    "6-0": "order_amount",
    "6-1": "`object`",
    "6-2": "An object that contains the transaction amount details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#order-amount-child-object\" >Learn more about our `order_amount` child object</a>.",
    "7-0": "pre_auth",
    "7-1": "`boolean`",
    ...
    "12-1": "`object`",
    "12-2": "An object that contains the purchase details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#purchase-details-child-object\" >Learn more about our `purchase_details` child object</a>.  \n  \n**Note**: The presence of the key-values pairs in this object depends on the Input request.",
    "13-0": "payments",
    "13-1": "`array of objects`",
    "13-2": "An array of object that contains the payment details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#payments-child-object\" >Learn more about our `payments` child object</a>.  \n  \n**Note**: Payments response object can vary based on the payment methods and payment status.",
    "14-0": "created_at",
    "14-1": "`string`",
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "customer",
    "0-1": "`Object`",
    "0-2": "An object that contains the customer details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#customer-child-object\" >Learn more about our `customer` child object</a>.",
...
[block:parameters]
{
  "data": {
    ...
    "5-0": "billing_address",
    "5-1": "`object`",
    "5-2": "An object that contains the details of the billing address.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#billing-address-child-object\" >Learn more about our `billing_address` child object</a>.",
    "6-0": "shipping_address",
    "6-1": "`object`",
    "6-2": "An object that contains the shipping address details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#shipping-address-child-object\" >Learn more about our `shipping_address` child object</a>."
  },
  "cols": 3,
  "rows": 7,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "3-0": "payment_amount",
    "3-1": "`object`",
    "3-2": "An object that contains the details of the payment amount.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#payment-amount-child-object\" >Learn more about our `payment_amount` child object</a>.",
    "4-0": "payment_method",
    "4-1": "`string`",
    "4-2": "Type of payment method.<br><br>Accepted values:<ul><li>`CARD`</li><li>`UPI`</li><li>`POINTS`</ul></li>Example: `CARD`",
    "5-0": "payment_option",
    "5-1": "`object`",
    "5-2": "An object that contains the details of the payment options.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#payment-option-child-object\" >Learn more about our `payment_option` child object</a>.",
    "6-0": "acquirer_data",
    "6-1": "`object`",
    "6-2": "An object that contains the details of the acquirer data.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#acquirer-data-child-object\" >Learn more about our `acquirer_data` child object</a>.",
    "7-0": "error_detail",
    "7-1": "`object`",
    "7-2": "An object that contains the error details.<br><br><a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#error-detail-child-object\" >Learn more about our `error_detail` child object</a>.<br><br>**Note**: This object is returned only for the failed payment.",
    "8-0": "capture_data",
    "8-1": "`object`",
    "8-2": "An object that contains the details of the capture data.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#capture-data-child-object\" >Learn more about our `capture_data` child object</a>.  \n  \n**Note**: The presence of the key-value pairs against this object depends on the pre-authorization type.",
    "9-0": "created_at",
    "9-1": "`string`",
    "9-2": "The ISO 8601 UTC Timestamp, when the create payment request was received by Plural.  \n  \nExample: `2024-09-02T07:27:11.240Z`",
    "10-0": "updated_at",
    "10-1": "`string`",
    "10-2": "The ISO 8601 UTC Timestamp, when the payment response object is updated.  \n  \nExample: `2024-09-02T07:27:52.950Z`"
  },
  "cols": 3,
  "rows": 11,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "card_data",
    "0-1": "`object`",
    "0-2": "An object that contains the card details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#card-data-child-object\" >Learn more about our `card_data` child object</a>.",
    "1-0": "points_card_details",
    "1-1": "`object`",
    "1-2": "An object that contains the point card details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#points-card-details-child-object\" >Learn more about our `points_card_details` child object</a>.  \n  \n**Note**:<ul><li>With Plural, you can pay the eligible amount through points with a card payment only.</li><li>Card payments and point payments are two separate payments bonded against an order.</ul></li>"
  },
  "cols": 3,
  "rows": 2,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "Type",
    "h-2": "Description",
    "0-0": "registered_mobile_number",
    "0-1": "`string`",
    "0-2": "Point card registered mobile number.<ul><li>Maximum length: 20 characters.</li><li>Minimum length: 9 characters.</ul></li>Example: `9876543210`<br><br>Supported characters:<ul><li>`0-9`</li><li>`+`",
    "1-0": "card_last4",
    "1-1": "`string`",
    "1-2": "The last four digits of your card number.  \n  \nHas to be 4 digits.  \n  \nExample: `1234`  \n  \nSupported characters: `0-9`",
    "2-0": "card_number",
    "2-1": "`string`",
    "2-2": "Card Number.<ul><li>Maximum length: 23 characters.</li><li>Minimum length: 12 characters.</ul></li>Example: `123456789012`<br><br>Supported characters: `0-9`"
  },
  "cols": 3,
  "rows": 3,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "1-0": "capture_amount",
    "1-1": "`object`",
    "1-2": "An object that contains the capture amount details.  \n  \n<a style=\"text-decoration:underline;\" href=\"https://developer.pluralonline.com/v3.0/reference/pay-by-point-object#capture-amount-child-object\" >Learn more about our `capture_amount` child object</a>.",
    "2-0": "created_at",
    "2-1": "`string`",
