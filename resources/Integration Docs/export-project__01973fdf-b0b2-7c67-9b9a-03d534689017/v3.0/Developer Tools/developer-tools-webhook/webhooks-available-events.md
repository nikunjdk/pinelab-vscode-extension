...
hidden: false
createdAt: "Tue Aug 13 2024 08:11:48 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Mon May 19 2025 07:57:04 GMT+0000 (Coordinated Universal Time)"
---
...
[block:parameters]
{
  "data": {
    "h-0": "Webhook",
    "h-1": "Description",
    "0-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#customer_activated\" >`CUSTOMER_ACTIVATED`</a>",
    "0-1": "When the customer is activated on Plural's platform.",
    "1-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#customer_deleted\" >`CUSTOMER_DELETED`</a>",
    "1-1": "When the customer is removed from Plural's system.",
    "2-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#customer_suspended\" >`CUSTOMER_SUSPENDED`</a>",
    "2-1": "When the customer is temporarily suspended on the Plural platform through the portal.",
    "3-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#customer_creation_failed\" >`CUSTOMER_CREATION_FAILED`</a>",
    "3-1": "When the customer creation is failed.",
    "4-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#order_authorized\" >`ORDER_AUTHORIZED`</a>",
    "4-1": "When the order is ready for authorization.",
    "5-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#order_processed\" >`ORDER_PROCESSED`</a>",
    "5-1": "When the payment is successfully received.",
    "6-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#order_cancelled\" >`ORDER_CANCELLED`</a>",
    "6-1": "When the order is cancelled.",
    "7-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#payment_failed\" >`PAYMENT_FAILED`</a>",
    "7-1": "When the payment against an order get failed.",
    "8-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#order_failed\" >`ORDER_FAILED`</a>",
    "8-1": "When the order is failed.",
    "9-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#refund_processed\" >`REFUND_PROCESSED`</a>",
    "9-1": "When the refund is successful.",
    "10-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#refund_failed\" >`REFUND_FAILED`</a>",
    "10-1": "When the refund against an order get failed.",
    "11-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#token_activated\" >`TOKEN_ACTIVATED`</a>",
    "11-1": "When the token is activated via the network.",
    "12-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#token_deactivated\" >`TOKEN_DEACTIVATED`</a>",
    "12-1": "When the token is deactivated.",
    "13-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#token_suspended\" >`TOKEN_SUSPENDED`</a>",
    "13-1": "When the token is suspended.",
    "14-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#token_provision_failed\" >`TOKEN_PROVISION_FAILED`</a>",
    "14-1": "When the token provisioning is failed.",
    "15-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#subscription_activated\" >`SUBSCRIPTION_ACTIVATED`</a>",
    "15-1": "When the subscription is activated.",
    "16-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#subscription_pending\" >`SUBSCRIPTION_PENDING`</a>",
    "16-1": "When the subscription is pending.",
    "17-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#subscription_paused\" >`SUBSCRIPTION_PAUSED`</a>",
    "17-1": "When the subscription is paused.",
    "18-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#subscription_resumed\" >`SUBSCRIPTION_RESUMED`</a>",
    "18-1": "When the subscription is resumed.",
    "19-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#subscription_completed\" >`SUBSCRIPTION_COMPLETED`</a>",
    "19-1": "When the subscription is completed.",
    "20-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#subscription_charged\" >`SUBSCRIPTION_CHARGED`</a>",
    "20-1": "When the successful charge is made on the subscription.",
    "21-0": "<a href=\"https://developer.pluralonline.com/reference/webhooks-available-events#subscription_halted\" >`SUBSCRIPTION_HALTED`</a>",
