...
slug: "integration-steps-3"
excerpt: "Learn how to integrate Plural cardless EMI in your application, enabling your customers to make payments without using Card."
hidden: false
createdAt: "Wed Nov 27 2024 07:57:14 GMT+0000 (Coordinated Universal Time)"
updatedAt: "Mon Apr 21 2025 06:32:08 GMT+0000 (Coordinated Universal Time)"
---
...
Use this API to check the card eligibility to make a cardless payment.

Use the below endpoints to check the eligibility to make a cardless payment.

```text Eligibility Check UAT Endpoint
POST: https://pluralqa.pinepg.in/v1/pre-eligibility-check
```
```text Eligibility Check Prod Endpoint
POST: https://api.pluralonline.com/v1/pre-eligibility-check
```

Shown below is the sample request and sample response for a Eligibility Check API.
...
```Text Order Confirmation Endpoint
